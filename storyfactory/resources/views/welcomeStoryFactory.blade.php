                        ...
                        <div class="ideas-manage-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" class="ionicon" viewBox="0 0 512 512">
                                ...
                                <path
                                    ...
                                    fill="none" stroke="#DF7C7A" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-width="32" />
                                <path d="M294 240s-21.51 16-38 16-38-16-38-16" fill="none" stroke="#DF7C7A"
                                    stroke-linecap="round" stroke-linejoin="round" stroke-width="32" />
                            </svg>
                        </div>
                        <div class="ideas-manage-title">Ideas Management</div>
                        <div class="ideas-manage-text">Turn your ideas into writing projects. Add as many projects as
                            you want and organize it by tags.
                        </div>
                    ...
                    <div class="outlining">
                        <div class="outlining-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" class="ionicon" viewBox="0 0 512 512">
                                ...
                                <circle cx="128" cy="256" r="48" fill="none" stroke="#DF7C7A" stroke-linecap="round"
                                    stroke-linejoin="round" stroke-width="32" />
                                <circle cx="384" cy="112" r="48" fill="none" stroke="#DF7C7A" stroke-linecap="round"
                                    stroke-linejoin="round" stroke-width="32" />
                                <circle cx="384" cy="400" r="48" fill="none" stroke="#DF7C7A" stroke-linecap="round"
                                    stroke-linejoin="round" stroke-width="32" />
                                <path fill="none" stroke="#DF7C7A" stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <div class="organize">
                        <div class="organize-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" class="ionicon" viewBox="0 0 512 512">
                                ...
                                <path d="M32 32v432a16 16 0 0016 16h432" fill="none" stroke="#DF7C7A"
                                    stroke-linecap="round" stroke-linejoin="round" stroke-width="32" />
                                <rect x="96" y="224" width="80" height="192" rx="20" ry="20" fill="none"
                                    stroke="#DF7C7A" stroke-linecap="round" stroke-linejoin="round" stroke-width="32" />
                        ...
                        <div class="organize-text">Forget the plots holes. Write better stories thanks to the
                            statistics of Story Planner.</div>
                    </div>
                </div>
            </div>
            <div class="photo"></div>
