...
<head>
	...
	<title>StoryFactory - Objects List</title>
</head>
<body>
    <div class="grid-container">
        ...
        <div class="wrapper">
            ...
            <div class="card_article">
                <div class="card_load"><span class="iconify" data-icon="clarity:objects-solid"></span></div>
                <div class="card_load_extreme_title">{{$a->name}}</div>
                <div class="card_load_extreme_descripion"></div>
                <div>
                    <a href="{{route("create_article")}}"><box-icon type='solid' name='plus-circle' color="#2c354d"></box-icon></a>
                    <a href="{{route("editarArticle",["id"=>$a->id_article])}}"><box-icon name='edit' type='solid' color='#0f8d48'></box-icon></a>
                    <a href="{{route("borrarArticle",["id"=>$a->id_article])}}"><box-icon type='solid' name='trash-alt' color="#7a1616"></a>
                </div>
            </div>
            @endforeach
        </div>
