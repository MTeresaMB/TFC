...
<head>
	...
	<title>StoryFactory - Your Places</title>
</head>
<body>
    ...
    <div class="grid-container">
        ...
        <div class="wrapper">
            ...
            <div class="card_place">
                <div class="card_load"><span class="iconify" data-icon="bxs:landscape"></span></div>
                <div class="card_load_extreme_title">{{$a->name}}</div>
                <div class="card_load_extreme_descripion">
                    <a href="{{route("create_place")}}"><box-icon type='solid' name='plus-circle' color="#2c354d"></box-icon></a>
                    <a href="{{route("editarPlace",["id"=>$a->id_place])}}"><box-icon name='edit' type='solid' color='#0f8d48'></box-icon></a>
                    <a href="{{route("borrarPlace",["id"=>$a->id_place])}}"><box-icon type='solid' name='trash-alt' color="#7a1616"></a>
                </div>
        </div>
        @endforeach
    </div>
